...
public class MessagePicturesLayout extends FrameLayout implements View.OnClickListener {
    ...
    public final List<ImageView> iPictureList = new ArrayList<>();
    public final SparseArray<ImageView> mVisiblePictureList = new SparseArray<>();
    private final TextView tOverflowCount;

    private Callback mCallback;
    public boolean isInit;
    public List<Uri> mDataList;
    ...
    public void notifyDataChanged() {
        ...
        Log.v("more", "MessagePicturesLayout, notifyDataChanged");
    ...
    public void onClick(View v) {
        Log.v("more", "MessagePicturesLayout, onClick");
        if (mCallback != null) {
